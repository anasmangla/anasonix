...
function sessionPage(entry, index) {
  ...
  const canonical = `https://anasmangla.github.io/anasonix/Qadian/sessions/${entry.slug}.html`;
  ...
  const absolutePhotoUrl = heroPhoto ? `https://anasmangla.github.io/anasonix/Qadian/${heroPhoto.src}` : "";
...
const sitemapUrls = [
  "https://anasmangla.github.io/anasonix/Qadian/",
  ...entries.map((entry) => `https://anasmangla.github.io/anasonix/Qadian/sessions/${entry.slug}.html`)
];
fs.writeFileSync(
